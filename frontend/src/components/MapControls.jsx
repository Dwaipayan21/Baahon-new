...
const MapControls = ({
  ...
  return (
    <div className="flex flex-col items-end gap-2.5 select-none">
      {/* Metro Active Status (Task 4 updated) */}
      <button
        type="button"
        ...
        className={`flex items-center justify-center transition-all cursor-pointer shadow-[0_4px_14px_rgba(0,0,0,0.08)] border ${
          showLegend
            ...
            : `w-11 h-11 rounded-full ${metroActive ? "bg-blue-50 border-blue-200 text-[#005bb3]" : "bg-white text-slate-700 border-slate-200 hover:bg-slate-50"}`
        }`}
      >
        {showLegend ? (
          <>
